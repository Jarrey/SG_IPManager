...
`索格 IPManager` 是一个轻量级 PHP 本地应用，专为家庭和小型办公网络的 DHCP 静态 IP 地址管理设计。它提供了直观的 Web 控制面板，支持用户登录、IP 绑定管理、子网空闲地址可视化，以及在线状态检测。

## 主要功能

- 登录认证与权限控制，默认账户 `admin/admin`
- 首次登录强制修改默认密码
...
查看英文说明请前往 [README_EN.md](README_EN.md)
